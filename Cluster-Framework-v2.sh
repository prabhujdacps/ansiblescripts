...
ansibleRun util server1,server2
ansible cluster cluster1 action=delete
ansible cluster cluster2 action=delete
ansible server server1 action=reinstall

ansible server server2 action=reinstall
ansible server server3 action=reinstall
ansible server server4 action=reinstall
ansible cluster cluster1 action=reinstall -t=install
ansible cluster cluster2 action=reinstall -t=install
##CPS
